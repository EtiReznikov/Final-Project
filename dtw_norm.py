...
#
#
#     seq1_v.append(seq1[:, 1 ,:])
#     seq1_v.append(seq1[:, 4 ,:])
#     joint1= np.reshape(seq1_v, (2,len1))
#     # print(np.shape(joint1))
#     seq2_v=[]
#
#     seq2_v.append(seq2[:, 1 ,:])
#     seq2_v.append(seq2[:, 4 ,:])
#     joint2= np.reshape(seq2_v, (2,len2))
#
#
#     print(np.shape(joint1))
#     joint1= normal_vec(joint1)
#     joint2= normal_vec(joint2)
#     # for j in range (0,7):
#     # joint1= seq1[:,1,:]
...
#     joint1= np.reshape(seq1_v, (6,len1))
#     # print(np.shape(joint1))
#     seq2_v=[]
#     for j in range (0,6):
#         joint2= seq2[:,j,:]
#         seq2_v.append(joint2)
#     joint2= np.reshape(seq2_v, (6,len2))
#
#
#
#     joint1= angles_unit_vector(joint1)
#     joint2= angles_unit_vector(joint2)
#     # for j in range (0,7):
#     # joint1= seq1[:,1,:]
#     # joint1= np.reshape(joint1, len1)
#     # # print(np.shape(joint1))
...
def dtw_per_joint(seq1, seq2):
    ...
    for j in range(0, 19):
        joint1 = seq1[:, j, :]
        seq1_v.append(joint1)
    joint1= np.reshape(seq1_v, (19,len1))
    # print(np.shape(joint1))
    seq2_v=[]
    ...
    for j in range (0,19):
        joint2= seq2[:,j,:]
        seq2_v.append(joint2)
    joint2= np.reshape(seq2_v, (19,len2))
